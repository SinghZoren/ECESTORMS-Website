  ...
  const eventContent = (eventInfo: EventContentArg) => {
    return (
      <div className="group relative">
        ...
        <div className="hidden group-hover:block absolute z-[100] bg-white p-4 rounded-lg shadow-lg border border-gray-200 min-w-[250px] transform -translate-x-1/2 left-1/2 mt-2">
          {/* Arrow pointer */}
