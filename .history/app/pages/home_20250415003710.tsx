        ...
        <div className="relative h-screen">
          ...
          <div className="absolute inset-0 z-0 overflow-hidden">
            <video
              ...
              muted
              playsInline
              className={`absolute w-[105%] h-[105%] object-cover scale-105 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-1000 ${showImage ? 'opacity-0' : 'opacity-100'}`}
            >
