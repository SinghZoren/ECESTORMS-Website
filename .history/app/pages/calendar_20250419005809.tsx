    ...
    const eventContent = (eventInfo: EventContentArg) => {
      ...
      return (
        ...
        >
          ...
          {showTooltip && (
            <div
              className="fixed z-[9999] bg-white p-4 rounded-lg shadow-lg border border-gray-200 w-[250px] pointer-events-none"
              style={{ top: coords.y + 20, left: coords.x }}
            >
              <div className="font-bold text-lg mb-1">{eventInfo.event.title}</div>
              <p className="text-gray-600">{eventInfo.event.extendedProps.time}</p>
