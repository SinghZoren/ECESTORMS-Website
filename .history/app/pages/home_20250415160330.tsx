    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <div className="relative bg-[#4A154B] py-[30%] -mt-[3.3%]">
          ...
          {/* Team Card */}
          <div className="absolute left-[5%] top-[35%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[3%] w-[90%] max-w-[39.1%] h-[35%] mx-auto md:left-[10%] md:w-[40%]">
            <h2 className={`${bebasNeue.className} text-4xl text-[#4A154B] mb-[2%]`}>
              Our Team
            </h2>
            <div className="relative h-[100%]">
              <div className="absolute left-[10%] bg-[#4A154B] shadow-xl p-[2%] w-[80%] h-[80%]">
              </div>
              <div className="absolute left-[5%] top-[8%] bg-[#000000] shadow-xl p-[2%] w-[80%] h-[80%]">
              </div>
            </div>
          </div>
          
          {/* Quick Links Card */}
          <div className="absolute right-[5%] top-[55%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[3%] w-[90%] max-w-[39.1%] mx-auto md:right-[10%] md:w-[40%]">
