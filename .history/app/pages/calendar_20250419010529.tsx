        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-white rounded-lg shadow-lg p-4">
            <FullCalendar
              ...
              eventClassNames="bg-[#931cf5] hover:bg-[#7a16d4] border-[#931cf5] !h-[30px] min-h-[30px]"
              eventDidMount={(info) => {
                ...
                info.el.style.setProperty('padding-top', '4px');
                info.el.style.setProperty('padding-bottom', '4px');
