      ...
      <div className="flex-grow">
        <div className="relative h-screen">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-screen text-center px-4">
            <div className="relative select-none -mt-[0.9%]">
              <h1 
              ...
              <h2 
                className={`text-[2.5rem] md:text-[3rem] font-medium text-white drop-shadow-lg -mt-[3.3%] relative z-10 ${bebasNeue.className}`}
              >
        ...
        {/* About Us Section */}
        <div className="relative bg-[#4A154B] min-h-[100%] -mt-[1.5%]">
          <div className="container mx-auto px-4">
            <div className="absolute right-[16.7%] top-[-1.5%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[2.7%] w-[39%] h-[32.4%]">
          ...
          <div className="absolute left-[16.7%] top-[5.9%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[2.7%] w-[39%] h-[37%]">
            <h2 className={`${bebasNeue.className} text-4xl text-[#4A154B] mb-4`}>
              Our Team
            </h2>
            <div className="absolute left-[1.3%] top-[5%] bg-[#4A154B] shadow-xl p-[2.7%] w-[80%] h-[50%]">
            </div>
            <div className="absolute left-[1%] top-[6.3%] bg-[#000000] shadow-xl p-[2.7%] w-[80%] h-[68.8%]">
            </div>
          </div>
          <div className="absolute right-[16.7%] top-[13.9%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[2.7%] w-[39%] h-[37%]">
