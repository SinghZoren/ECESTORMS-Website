  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        {/* About Us Section */}
        <div className="relative bg-[#4A154B] py-[30rem] -mt-[10rem]">
          {/* About Us Card */}
          <div className="absolute right-[5%] -top-[6rem] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-6 w-[90%] max-w-[750px] mx-auto md:right-[10%] md:w-[40%]">
