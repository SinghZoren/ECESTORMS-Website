    ...
    return (
      <div className="group relative">
        ...
        <div className="hidden group-hover:block fixed z-[9999] bg-white p-4 rounded-lg shadow-xl border border-gray-200 min-w-[300px] max-w-[400px]" 
             style={{
               left: `${(eventInfo.event.el as HTMLElement).getBoundingClientRect().left}px`,
               top: `${(eventInfo.event.el as HTMLElement).getBoundingClientRect().bottom + window.scrollY + 5}px`
             }}>
          {/* Arrow pointer */}
