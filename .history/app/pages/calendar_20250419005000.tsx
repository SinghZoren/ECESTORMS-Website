...
export default function Calendar() {
  ...
  const eventContent = (eventInfo: { event: any }) => {
    return (
      <div className="group relative">
        <div>{eventInfo.event.title}</div>
        <div className="hidden group-hover:block absolute z-50 bg-white p-4 rounded-lg shadow-lg border border-gray-200 min-w-[200px]">
