    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <div className="relative bg-[#4A154B] py-[30%] -mt-[3.3%]">
          {/* About Us Card */}
          <div className="absolute right-[5%] -top-[6rem] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-6 w-[90%] max-w-[39.1%] mx-auto md:right-[10%] md:w-[40%]">
          ...
          {/* Team Card */}
          <div className="absolute left-[5%] top-[15rem] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-6 w-[90%] max-w-[39.1%] mx-auto md:left-[10%] md:w-[40%]">
            <h2 className={`${bebasNeue.className} text-4xl text-[#4A154B] mb-4`}>
              Our Team
            </h2>
            <div className="relative h-[250px]">
              <div className="absolute left-[10%] top-[20px] bg-[#4A154B] shadow-xl p-4 w-[80%] h-[13.8%]">
              </div>
              <div className="absolute left-[5%] top-[40px] bg-[#000000] shadow-xl p-4 w-[80%] h-[18.51]">
              </div>
            </div>
          </div>
