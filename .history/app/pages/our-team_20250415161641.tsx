...
const TeamSection = ({ title, members }: { title: string, members: TeamMember[] }) => {
  return (
    <div className="mb-[8%]">
      <h2 className="text-2xl md:text-3xl font-bold text-[#4A154B] mb-[3%] border-b-2 border-[#931cf5] pb-[1%]">
        {title}
      </h2>
...
export default function OurTeam() {
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow bg-gradient-to-b from-white to-gray-100 pt-[10%]">
        <main className="container mx-auto px-[4%] py-[5%]">
          ...
          <div className="max-w-[90%] mx-auto">
            <p className="text-lg text-gray-700 mb-[5%] text-center">
              Meet the dedicated individuals who make ECESTORMS possible. Our team works tirelessly to enhance the academic and professional journey of Electrical and Computer Engineering students at TMU.
            </p>
            
            {/* Executive Team */}
            <TeamSection title="Executive Team" members={executiveMembers} />
