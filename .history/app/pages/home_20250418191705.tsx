    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <div className="relative bg-[#4A154B] py-[30%] -mt-[3.3%]">
          {/* About Us Card */}
          <div className="absolute right-[5%] top-[-5.5%] bg-white/80 backdrop-blur-sm shadow-lg shadow-xl p-[3%] w-[90%] max-w-[39.1%] h-[35%] mx-auto md:right-[10%] md:w-[40%] overflow-hidden">
            <h2 className={`${bebasNeue.className} text-4xl text-[#4A154B] mb-[2%]`}>
              About Us
            </h2>
            <div className="h-[85%] overflow-auto">
              <p className="text-gray-700 leading-relaxed font-medium text-base sm:text-lg md:text-xl xl:text-xl tracking-wide">
